...
from facial_points import NOSE_CENTER, EYEBROW_L_RIGHT, EYEBROW_R_LEFT, SILHOUETTE_BOTTOM
...
def get_pose(facial_landmarks, debug_image=None):
    ...
    eyebrow_c = Landmark(
                                (facial_landmarks[EYEBROW_L_RIGHT].x + facial_landmarks[EYEBROW_R_LEFT].x) / 2,
                                (facial_landmarks[EYEBROW_L_RIGHT].y + facial_landmarks[EYEBROW_R_LEFT].y) / 2,
                                (facial_landmarks[EYEBROW_L_RIGHT].z + facial_landmarks[EYEBROW_R_LEFT].z) / 2
                              )

    x_angle = np.arctan2(facial_landmarks[NOSE_CENTER].y - eyebrow_c.y, facial_landmarks[NOSE_CENTER].z - eyebrow_c.z)
    ...
    z_angle = np.arctan2(eyebrow_c.y - facial_landmarks[SILHOUETTE_BOTTOM].y, eyebrow_c.x - facial_landmarks[SILHOUETTE_BOTTOM].x)
    ...
    if debug_image is not None:
        ...
        # draw mouth
        debug_image = cv2.line(debug_image, [int(facial_landmarks[NOSE_CENTER].x * w), int(facial_landmarks[NOSE_CENTER].y * h)],
                              [int(facial_landmarks[EYEBROW_CENTER].x * w), int(facial_landmarks[EYEBROW_CENTER].y * h)], (0, 0, 255), 1)
        ...
        return (eye_l_h_temp, eye_r_h_temp, mouth_ratio, 0, 0, x_angle , y_angle, z_angle), None
