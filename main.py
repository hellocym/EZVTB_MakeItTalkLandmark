...
from tha.puppet.head_pose_solver import HeadPoseSolver
...
def main():
    ...
    # landmarks = 'landmarks/pred_fls_output_audio_embed.txt'
    ...
    while True:
        ...
        if args.perf == 'main':
            tic = time.perf_counter()
        # modified debug_input
        if args.debug_input:
            # facial_landmarks = next(g)
            ...
            # add random blink, once 3~5 seconds, 0.3 seconds long
            ...
            if is_blinking:
                # print(time_since_blink)
                eye_l_h_temp = blink_function(time_since_blink, 0.2)
                eye_r_h_temp = blink_function(time_since_blink, 0.2)
                # print(eye_l_h_temp)
            ...
            mouth_eye_vector_c[14] = mouth_ratio * mouth_multiplier
